...
public class Embilta extends Activity {
	WebView wv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wv.loadUrl("file:///android_asset/embilta.htm");
		 ...
		 * wv.loadUrl("file:///android_asset/embilta2.htm"); } else {
		 * wv.loadUrl("file:///android_asset/embilta.htm"); } } });
		 */
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case android.R.id.home:
			...
			return true;
		case R.id.help:
			wv.loadUrl("file:///android_asset/embilta2.htm");
