...
public class Mekuamia extends Activity {
	WebView wv;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wv.loadUrl("file:///android_asset/mekuamia.htm");
		 ...
		 * wv.loadUrl("file:///android_asset/mekuamia2.htm"); } else {
		 * wv.loadUrl("file:///android_asset/mekuamia.htm"); } } });
		 */
	...
	public boolean onOptionsItemSelected(final MenuItem item) {
		...
		case android.R.id.home:
			...
			return true;
		case R.id.help:
			wv.loadUrl("file:///android_asset/mekuamia2.htm");
